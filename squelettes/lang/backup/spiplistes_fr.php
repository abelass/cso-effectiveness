...
'contributions' => "Merci d’envoyer vos contributions, commentaries et questions a",
'editeur' => 'Editeur : ',
...
'pied' => 'Votre logiciel de messagerie ne peut apparemment pas afficher correctement la version graphique (HTML) de cet e-mail',
'read_more' => "Lire l'article entier",
'sans_adresse' => 'Mail non envoy&eacute; -> Veuillez d&eacute;finir une adresse de r&eacute;ponse',
'texte_explicatif' => "C'est la lettre d'information mensuelle du Forum sur l’efficacité du développement des OSC. Il est une publication libre et en ligne destinée à partager de l'information sur des questions liées à l'efficacité des organisations de la société civile en général et du processus sur l’efficacité des OSC en particulier.<br/><br/>Visitez notre site web : <a href='http://www.cso-effectiveness.org'>www.cso-effectiveness.org</a></p><p>Merci d’envoyer vos contributions, commentaries et questions à",
'texte_pied' => "Vous avez reçu cet e-mail parce que vous êtes sur la liste d'envoi du Forum sur l'efficacité du éveloppement des OSC.
<br/>Commentaires, suggestions et contributions peuvent être envoyées à",
