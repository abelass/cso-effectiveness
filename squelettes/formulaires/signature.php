...
function formulaires_signature_verifier_dist($id_article, $petition, $texte, $site_obli, $message) {
	...
	if (!_request('type_organisation')){
			$erreurs['type_organisation'] = _T('info_obligatoire');
...
function formulaires_signature_traiter_dist($id_article, $petition, $texte, $site_obli, $message) {
	...
	if (spip_connect()) {
		...
		_request('signature_url_site'), _request('url_page'),_request('type_organisation'),_request('nom_contact'));
	}
...
function inc_controler_signature_dist($id_article, $nom, $mail, $message, $site, $url_site, $url_page,$type_organisation,$nom_contact) {
	...
	$statut = "";
	if (!$ret = signature_a_confirmer($id_article, $url_page, $nom, $mail, $site, $url_site, $message, $lang, $statut,$type_organisation,$nom_contact))
		return _T('form_pet_probleme_technique');
...
function signature_a_confirmer($id_article, $url_page, $nom, $mail, $site, $url, $msg, $lang, &$statut,$type_organisation,$nom_contact)
{
